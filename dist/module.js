class $4d1bc26e949f9569$export$2e2bcd8739ae039 {
    ...
    parse(content) {
        ...
        for (const frame of doc.querySelector('ga-frame'))frames.set(frame.getAttribute('name'), frame.innerHTML);
        return {
            title: doc.title,
            frames: frames,
            scripts: [
    ...
    constructor(){
        ...
        const frames = new Map();
        for (const frame of document.querySelectorAll('ga-frame'))frames.set(frame.getAttribute('name'), frame.innerHTML);
